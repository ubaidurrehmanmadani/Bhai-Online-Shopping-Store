                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
							...
							<table class="order-table">
								...
								<tr>
									<th class="order-status">From Customer</th>
									<th class="order-status">To Delivery Boy</th>
								...
								$productInfo=null;
								$productInfo=$administrator->viewCustomerFeedbacks();
								foreach($productInfo as $data){
								?>
								<tr>
								
									<td class="order-number"><p><a href="#"><?php echo $data["customer"];?></a></p></td>
									<td><p><?php echo $data["bhai"];?></p></td>
