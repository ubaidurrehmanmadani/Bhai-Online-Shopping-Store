...
$user->registerUser($_POST["name"],$_POST["DOB"],$_POST["CNIC"],$_POST["password"],$_POST["phone"],$_POST["gender"],1,$_POST['Y-m-d H:i:s'],1,$_POST["province"],$_POST["district"],$_POST["city"],$_POST["tehsil"],$_POST["comAddress"],$_POST["saf"]);
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 register-account">
                            ...
                            <div class="page-content">
								...
								<div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                    	<input type="text" name="comAddress">
                                    </div>	
