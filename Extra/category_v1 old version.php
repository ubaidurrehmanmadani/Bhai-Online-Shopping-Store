			...
			<form method="post" name="form2" id="form2">	
                <div class="col-lg-12 col-md-12 col-sm-12">
                	<div class="breadcrumbs">
                    	<p><a href="main1.php">Home</a> <i class="icons icon-right-dir"></i> Recent Items</p>
                    </div>
                </div>
                            ...
                            <div class="row subcategories">
                               ...
                               <div class="row subcategories">
                                ...
                                <div class="col-lg-fifth col-md-fifth col-sm-fifth subcategory" onclick="window.location.href='productdetail.php?name=<?php echo $data["product_id"]; ?>'">
                                    ...
                                    <a href="#"><img src="<?php echo $data["img_src"]  ?>" alt="images/Grapes.jpg" onerror="this.src='images/Grapes.jpg';"></a>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                        	<div class="category-heading">
								<select class="chosen-select">
                                      ...
                                      $product=new Product();
									   $productInfo=$product->viewRecentProducts(); 
										foreach($productInfo as $data){ ?><option><?php echo $data["product_name"];  ?></option><?php $count++;if($count==30){break;}}?>		
                               ...
                               <!-- <select class="chosen-select">
                                ...
                                <div class="category-buttons">
									<a href="category_v1.php"><i class="icons icon-th-3 active-button"></i></a>
									<a href="category_v2.php"><i class="icons icon-th-list-4"></i></a>
								</div>
							</div>
                        </div>
