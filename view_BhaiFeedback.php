			...
			<div class="row content">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                	<div class="breadcrumbs">
                    	<p><a href="admin_panel.php">Home</a> <i class="icons icon-right-dir"></i>Feedbacks</p>
                    </div>
                </div>
                <!-- Main Content -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
							...
							<table class="order-table">
								...
								<tr>
									<th class="order-status">From Bhai</th>
									<th class="order-status">To Customer</th>
									<th class="order-status">Feedback Description</th>
									<th >Rating Value</th>
									<th >Order Number</th>
								...
								$productInfo=null;
								$productInfo=$administrator->viewBhaiFeedbacks();
								foreach($productInfo as $data){
								?>
								<tr>
								
									<td class="order-number"><p><a href="#"><?php echo $data["bhai"];?></a></p></td>
									<td><p><?php echo $data["customer"];?></p></td>
									<td><p><?php echo $data["feedback"];?></p></td>
									<td><p><?php echo $data["rating"];?></p></td>
