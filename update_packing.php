...
//print_r($_POST);
$product = new Product();		
$product->addLog($_SESSION['user'],"Packing Updated",$_POST["txtupdateId"]);	    
$product->updatePacking($_POST["inputAddPacking"],$_POST["txtupdateId"]);
echo "<script>window.location.replace('delete_packing.php');</script>";
			...
			<div class="row content">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                	<div class="breadcrumbs">
                    	<p><a href="admin_panel.php">Home</a> <i class="icons icon-right-dir"></i> Update Packing</p>
                    </div>
                </div>
                                ...
                                <table class="compare-table">  
									...
									<tr>
										<td>Enter Packing Name</td>
										  <?php 
											   $product=new Product();
											   $result=$product->getPackingName($_POST["txtId"]);
											      foreach($result as $result1){
											  ?>
												  <td class="product-thumbnail"><input type="text" name="inputAddPacking" value="<?php echo $result1["packing_name"];  ?>" onkeypress="return isCharacter(event)"/></td><?php } ?>
									</tr>
                                    </br>
									<tr>
