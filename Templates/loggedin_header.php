...
<ul class="pull-left">
<li><a href="update_user.php">Update Account</a></li>
...
<li><img src="<?php echo $_SESSION['image']; ?>" width="30px"  height="30px"> </img></li>
...
<li class="orange"><a href="cart.php"><i class="icons icon-basket-2"></i><?php  if(!empty($_SESSION["ca"])) {echo  count($_SESSION["ca"]);}else{echo "0";}?> Items</a>
...
<td><strong class="parent-color"><?php if(!empty($_SESSION["total"])) {echo  $_SESSION["total"];}else{echo "0";} ?>.00</strong></td>
</tr>
</table>
</div>
