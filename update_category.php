...
//print_r($_POST);
$product = new Product();		
$product->addLog($_SESSION['user'],"Category Updated",$_POST["txtupdateId"]);
$product->updateCategory($_POST["inputAddCategory"],$_POST["dropdownParentCategory"],$_POST["txtupdateId"]);
echo "<script>window.location.replace('delete_category.php');</script>";
                                ...
                                <table class="compare-table">  
									...
									<tr>
										<td>Enter Category Name</td>
										  <?php 
											   $product=new Product();
											   $result=$product->getCategoryName($_POST["txtId"]);
											      foreach($result as $result1){
											  ?>
												  <td class="product-thumbnail"><input type="text" name="inputAddCategory" value="<?php echo $result1["category_name"];  ?>" onkeypress="return isCharacter(event)"/></td><?php } ?>
									</tr>
                                    </br>
									<tr>
